...
const systems = [
  { number: "01", title: "Your fit profile", copy: "Keep only the measurements, size history and preferences that make a better next choice. It stays private by default.", href: "/profile", icon: UserCircleIcon },
  ...
  return <main className="landing-main">
    <section className="pair-hero">
      <div className="pair-copy">
        <p className="eyebrow">Independent underwear intelligence</p>
        <h1>Find what supports<br /><em>your real day.</em></h1>
        <p className="pair-lead">PerfectPair brings bras and tights into one private research space—so product details, real-world experience and your own needs can work together.</p>
        ...
        <Link className="find-button pair-cta" href="/profile">Build my pair <ArrowRightIcon size={17} /></Link>
    ...
    <section className="pair-principle"><span>Independent research. A more considered you.</span><p>Personal Match and Community Score are separate. One is private guidance; the other is moderated, product-level experience.</p></section>

    <section className="systems-section" aria-labelledby="systems-title">
      <div className="section-heading"><div><p className="eyebrow">The four systems behind every better pair</p><h2 id="systems-title">One brand. Four trustworthy layers.</h2></div><p className="systems-intro">The site is designed as a research platform, not a retailer: what a brand says, what people experience and what suits you remain visibly distinct.</p></div>
