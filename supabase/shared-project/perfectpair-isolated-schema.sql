...
-- BEGIN 202609170003_four_category_catalog_pipeline.sql
...
-- END 202609170003_four_category_catalog_pipeline.sql


-- BEGIN 202609170004_catalog_100_target_queue.sql
...
alter table perfectpair.brand_source_targets
...
insert into perfectpair.brand_source_targets (
...
comment on table perfectpair.brand_source_targets is 'Finite 100-brand four-category coverage queue. Targets are not publication or image-rights claims.';

-- END 202609170004_catalog_100_target_queue.sql
